<nav id="top_nav" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" id="home_button" href="<?= $config["url"] ?>"><?php if(!empty($config["logo"])) { ?><img src="<?= $config["url"] ?>images/system/<?= $config["logo"] ?>" height="100%" alt="<?= $config["name"] ?>'s Logo"><?php } else { ?><?= $config["name"] ?><?php } ?></a>
        </div>

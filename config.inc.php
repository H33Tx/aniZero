...
//$config["home"] = "animes";
$config["cleanip"] = "false"; // Collect unhashed ips? (recomended: false)

$slave["host"] = "localhost"; // Database Host
$slave["user"] = "root"; // Database User
$slave["pass"] = "root"; // User Password
$slave["tale"] = "anizero"; // Database Table
